...
(function(jQuery) {
    jQuery.fn.easyAccordion = function(options) {
        ...
        this.each(function() {
            ...
            jQuery(this).find('.acPanel').addClass('easy-accordion');
            ...
            jQuery.fn.setVariables = function() {
                ...
                dtWidth = jQuery(this).find('.acHeader').outerHeight();
                if (jQuery.browser.msie){ dtWidth = $(this).find('.acHeader').outerWidth();}
                dtHeight = dlHeight - (jQuery(this).find('.acHeader').outerWidth()-jQuery(this).find('.acHeader').width());
                slideTotal = jQuery(this).find('.acHeader').size();
                ddWidth = dlWidth - (dtWidth*slideTotal) - (jQuery(this).find('.acPanel').outerWidth(true)-jQuery(this).find('.acPanel').width());
                ddHeight = dlHeight - (jQuery(this).find('.acPanel').outerHeight(true)-jQuery(this).find('.acPanel').height());
            };
