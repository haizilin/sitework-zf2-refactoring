...
abstract class BaseProjectPeer {
	...
	const OM_CLASS = 'Orm\\Model\\PropelOrm\\Project';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'PropelOrm.Project';
	...
	/** the column name for the FK_CONTACT_CLIENT_ID field */
	const FK_CONTACT_CLIENT_ID = 'project.FK_CONTACT_CLIENT_ID';

	/** the column name for the FK_CONTACT_EMPLOYER_ID field */
	const FK_CONTACT_EMPLOYER_ID = 'project.FK_CONTACT_EMPLOYER_ID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FkContactClientId', 'FkContactEmployerId', 'StartedAt', 'FinishedAt', 'Url', 'Img', 'Active', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fkContactClientId', 'fkContactEmployerId', 'startedAt', 'finishedAt', 'url', 'img', 'active', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FK_CONTACT_CLIENT_ID, self::FK_CONTACT_EMPLOYER_ID, self::STARTED_AT, self::FINISHED_AT, self::URL, self::IMG, self::ACTIVE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FK_CONTACT_CLIENT_ID', 'FK_CONTACT_EMPLOYER_ID', 'STARTED_AT', 'FINISHED_AT', 'URL', 'IMG', 'ACTIVE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'fk_contact_client_id', 'fk_contact_employer_id', 'started_at', 'finished_at', 'url', 'img', 'active', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FkContactClientId' => 1, 'FkContactEmployerId' => 2, 'StartedAt' => 3, 'FinishedAt' => 4, 'Url' => 5, 'Img' => 6, 'Active' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fkContactClientId' => 1, 'fkContactEmployerId' => 2, 'startedAt' => 3, 'finishedAt' => 4, 'url' => 5, 'img' => 6, 'active' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FK_CONTACT_CLIENT_ID => 1, self::FK_CONTACT_EMPLOYER_ID => 2, self::STARTED_AT => 3, self::FINISHED_AT => 4, self::URL => 5, self::IMG => 6, self::ACTIVE => 7, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FK_CONTACT_CLIENT_ID' => 1, 'FK_CONTACT_EMPLOYER_ID' => 2, 'STARTED_AT' => 3, 'FINISHED_AT' => 4, 'URL' => 5, 'IMG' => 6, 'ACTIVE' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fk_contact_client_id' => 1, 'fk_contact_employer_id' => 2, 'started_at' => 3, 'finished_at' => 4, 'url' => 5, 'img' => 6, 'active' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ProjectPeer::FK_CONTACT_CLIENT_ID);
			$criteria->addSelectColumn(ProjectPeer::FK_CONTACT_EMPLOYER_ID);
			$criteria->addSelectColumn(ProjectPeer::STARTED_AT);
			$criteria->addSelectColumn(ProjectPeer::FINISHED_AT);
			$criteria->addSelectColumn(ProjectPeer::URL);
			$criteria->addSelectColumn(ProjectPeer::IMG);
			$criteria->addSelectColumn(ProjectPeer::ACTIVE);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.FK_CONTACT_CLIENT_ID');
			$criteria->addSelectColumn($alias . '.FK_CONTACT_EMPLOYER_ID');
	 ...
	 *
	 * @param      Project $value A Project object.
	...
	/**
	 * Returns the number of rows matching criteria, joining the related ContactRelatedByFkContactClientId table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinContactRelatedByFkContactClientId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProjectPeer::FK_CONTACT_CLIENT_ID, ContactPeer::ID, $join_behavior);
	...
	/**
	 * Returns the number of rows matching criteria, joining the related ContactRelatedByFkContactEmployerId table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinContactRelatedByFkContactEmployerId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ProjectPeer::FK_CONTACT_EMPLOYER_ID, ContactPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Project objects pre-filled with their Contact objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinContactRelatedByFkContactClientId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Project) to $obj2 (Contact)
				$obj2->addProjectRelatedByFkContactClientId($obj1);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinContactRelatedByFkContactEmployerId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Project) to $obj2 (Contact)
				$obj2->addProjectRelatedByFkContactEmployerId($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Project) to the collection in $obj2 (Contact)
				$obj2->addProjectRelatedByFkContactClientId($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Project) to the collection in $obj3 (Contact)
				$obj3->addProjectRelatedByFkContactEmployerId($obj1);
			} // if joined row not null
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptContactRelatedByFkContactClientId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptContactRelatedByFkContactEmployerId(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Project objects pre-filled with all related objects except ContactRelatedByFkContactClientId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptContactRelatedByFkContactClientId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	/**
	 * Selects a collection of Project objects pre-filled with all related objects except ContactRelatedByFkContactEmployerId.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptContactRelatedByFkContactEmployerId(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
		return $withPrefix ? ProjectPeer::CLASS_DEFAULT : ProjectPeer::OM_CLASS;
	}
