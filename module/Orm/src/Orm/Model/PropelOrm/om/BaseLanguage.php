...
abstract class BaseLanguage extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array CategoryDetail[] Collection to store aggregation of CategoryDetail objects.
	 */
	protected $collCategoryDetails;

	/**
	 * @var        array ServiceDetail[] Collection to store aggregation of ServiceDetail objects.
	 */
	protected $collServiceDetails;

	/**
	 * @var        array ProjectDetail[] Collection to store aggregation of ProjectDetail objects.
	 */
	...
	public function initRelation($relationName)
	{
		if ('CategoryDetail' == $relationName) {
			return $this->initCategoryDetails();
		}
		if ('ServiceDetail' == $relationName) {
			return $this->initServiceDetails();
		}
		if ('ProjectDetail' == $relationName) {
			return $this->initProjectDetails();
		}
	}
	 ...
	 * @return     PropelCollection|array CategoryDetail[] List of CategoryDetail objects
	 * @throws     PropelException
	 */
	public function getCategoryDetails($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collCategoryDetails || null !== $criteria) {
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array ServiceDetail[] List of ServiceDetail objects
	 * @throws     PropelException
	 */
	public function getServiceDetails($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collServiceDetails || null !== $criteria) {
	 ...
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 * @return     PropelCollection|array ProjectDetail[] List of ProjectDetail objects
	 * @throws     PropelException
	 */
	public function getProjectDetails($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collProjectDetails || null !== $criteria) {
