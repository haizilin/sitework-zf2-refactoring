...
abstract class BaseServicePeer {
	...
	const CLASS_DEFAULT = 'PropelOrm.Service';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::FK_CATEGORY_ID, self::POS, self::ACTIVE, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FK_CATEGORY_ID => 1, self::POS => 2, self::ACTIVE => 3, ),
