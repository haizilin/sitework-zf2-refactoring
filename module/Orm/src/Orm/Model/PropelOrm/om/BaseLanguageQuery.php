...
abstract class BaseLanguageQuery extends ModelCriteria
{
	...
	protected function findPkSimple($key, $con)
	{
		...
		if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$obj = new Language();
			$obj->hydrate($row);
			LanguagePeer::addInstanceToPool($obj, (string) $row[0]);
		}
		$stmt->closeCursor();
	 ...
	 *
	 * @param     CategoryDetail $categoryDetail  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    LanguageQuery The current query, for fluid interface
	 */
	public function filterByCategoryDetail($categoryDetail, $comparison = null)
	{
		...
		} elseif ($categoryDetail instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     ServiceDetail $serviceDetail  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    LanguageQuery The current query, for fluid interface
	 */
	public function filterByServiceDetail($serviceDetail, $comparison = null)
	{
		...
		} elseif ($serviceDetail instanceof PropelCollection) {
			return $this
	 ...
	 *
	 * @param     ProjectDetail $projectDetail  the related object to use as filter
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    LanguageQuery The current query, for fluid interface
	 */
	public function filterByProjectDetail($projectDetail, $comparison = null)
	{
		...
		} elseif ($projectDetail instanceof PropelCollection) {
			return $this
