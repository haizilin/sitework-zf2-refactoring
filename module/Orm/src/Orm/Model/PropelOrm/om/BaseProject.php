...
abstract class BaseProject extends BaseObject  implements Persistent
{
	 ...
	 * @throws     PropelException
	 */
	public function getContactRelatedByFkContactClientId(PropelPDO $con = null)
	{
		if ($this->aContactRelatedByFkContactClientId === null && ($this->fk_contact_client_id !== null)) {
	 ...
	 * @throws     PropelException
	 */
	public function getContactRelatedByFkContactEmployerId(PropelPDO $con = null)
	{
		if ($this->aContactRelatedByFkContactEmployerId === null && ($this->fk_contact_employer_id !== null)) {
