...
abstract class BaseProjectDetailPeer {
	...
	const CLASS_DEFAULT = 'PropelOrm.ProjectDetail';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::FK_PROJECT_ID, self::FK_LANG_ID, self::LABEL, self::DESCRIPTION, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::FK_PROJECT_ID => 0, self::FK_LANG_ID => 1, self::LABEL => 2, self::DESCRIPTION => 3, ),
	 ...
	 *
	 * @param      ProjectDetail $value A ProjectDetail object.
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ProjectDetailPeer::getOMClass(false);
	...
	{
		return $withPrefix ? ProjectDetailPeer::CLASS_DEFAULT : ProjectDetailPeer::OM_CLASS;
	}
