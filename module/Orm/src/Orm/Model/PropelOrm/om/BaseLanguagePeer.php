...
abstract class BaseLanguagePeer
{
    ...
    const OM_CLASS = 'Orm\\Model\\PropelOrm\\Language';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Locale', 'Active', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'locale', 'active', ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::LOCALE, LanguagePeer::ACTIVE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LOCALE', 'ACTIVE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'locale', 'active', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Locale' => 1, 'Active' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'locale' => 1, 'active' => 2, ),
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::LOCALE => 1, LanguagePeer::ACTIVE => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LOCALE' => 1, 'ACTIVE' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'locale' => 1, 'active' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
