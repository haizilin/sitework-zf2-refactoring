...
use Orm\Model\PropelOrm\map\ContactTableMap;
...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'Orm\\Model\\PropelOrm\\Contact';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::LABEL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'LABEL', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::LABEL => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'LABEL' => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactPeer::LABEL);
        } else {
