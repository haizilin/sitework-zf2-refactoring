...
use Orm\Model\PropelOrm\map\CategoryTableMap;
...
abstract class BaseCategoryPeer {
	...
	const OM_CLASS = 'Orm\\Model\\PropelOrm\\Category';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'PropelOrm.Category';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::ACTIVE, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ACTIVE => 1, ),
